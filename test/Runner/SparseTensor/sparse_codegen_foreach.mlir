// DEFINE: %{option} = "enable-runtime-library=false reassociate-fp-reductions=true enable-index-optimizations=true"
...
// llvm-project/mlir/test/Integration/Dialect/SparseTensor/CPU/sparse_codegen_foreach.mlir
