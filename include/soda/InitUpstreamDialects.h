//===- InitUpstreamDialects.h - MLIR Extension Registration ---*- C++ -*-===//
//
//===----------------------------------------------------------------------===//
//
...
//
// This file is edited from llvm-project/mlir/include/mlir/InitAllDialects.h
// preserving only the registrations used in the SODA compiler.
//
//===----------------------------------------------------------------------===//

#ifndef SODA_INITUPSTREAMDIALECTS_H_
#define SODA_INITUPSTREAMDIALECTS_H_
...
inline void registerUpstreamDialects(MLIRContext &context) {
...
#endif // SODA_INITUPSTREAMDIALECTS_H_
